...
unlocked to sign the Beardcoin-Qt.app bundle.
...
allowing somebody to distribute a Beardcoin-Qt.app or beardcoin-qt-setup.exe with a valid
...
that the beardcoin-qt.exe file inside the installer had not been tampered with.
