...
#   d) node0 sends 21 bdc to node2, in two transactions (11 bdc, then 10 bdc).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 BDC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 bdc in block rewards plus fees, but
        ...
        # Send 10 BDC with subtract fee from amount
        ...
        # Sendmany 10 BDC with subtract fee from amount
