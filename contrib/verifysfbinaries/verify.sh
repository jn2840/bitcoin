...
###   This script attempts to download the signature file SHA256SUMS.asc from beardcoin.org
...
WORKINGDIR="/tmp/beardcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://beardcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://beardcoin.org/bin/"
VERSIONPREFIX="beardcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'beardcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[beardcoin-]<version>-[rc[0-9]] (example: beardcoin-0.9.2-rc1)"
   echo "wget output:"
