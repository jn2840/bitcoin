...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Beardcoin Core beardcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beardcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beardcoin transaction") + "\n" +
              "  beardcoin-tx [options] -create [commands]   " + _("Create hex-encoded beardcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded beardcoin transaction
