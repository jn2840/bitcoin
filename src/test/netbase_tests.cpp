// Copyright (c) 2012-2013 The Beardcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.beardcoin.org", "www.beardcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.beardcoin.org]", "www.beardcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.beardcoin.org:80", "www.beardcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.beardcoin.org]:80", "www.beardcoin.org", 80));
