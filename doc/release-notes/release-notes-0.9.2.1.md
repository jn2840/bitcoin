Beardcoin Core version 0.9.2.1 is now available from:

  https://beardcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BDC to 0.01 BDC
...
- Fix "Start beardcoin on system login"
