Beardcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/beardcoin/files/Beardcoin/beardcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Beardcoin
...
New/changed settings (command-line or beardcoin.conf file)
--------------------------------------------------------
