Beardcoin Core version 0.9.4 is now available from:

  https://beardcoin.org/bin/0.9.4/
...
this update is incompatible with the Beardcoin system and could lead to consensus
forks.

Beardcoin Core released binaries from https://beardcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~beardcoin/+archive/ubuntu/beardcoin
- A third-party or self-compiled Beardcoin Core

upgrade to Beardcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
