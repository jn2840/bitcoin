Download URL: https://sourceforge.net/projects/beardcoin/files/Beardcoin/beardcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BDC fee schedule (users still pay 0.01 BDC per kb, until next version)
