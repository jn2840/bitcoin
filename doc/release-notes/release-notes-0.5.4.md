Beardcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/beardcoin/files/Beardcoin/beardcoin-0.5.4/
...
http://gitorious.org/beardcoin/bitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Beardcoin-Qt notifications under Growl 1.3.
Increase required age of Beardcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Beardcoin-Qt over it. (Windows)
