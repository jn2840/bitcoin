Beardcoin Core version 0.9.0 is now available from:

  https://beardcoin.org/bin/0.9.0/
...
earlier versions of Beardcoin, then run the installer (on Windows) or just copy
over /Applications/Beardcoin-Qt (on Mac) or bitcoind/beardcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the Beardcoin
...
Rebranding to Beardcoin Core
---------------------------

To reduce confusion between Beardcoin-the-network and Beardcoin-the-software we
have renamed the reference client to Beardcoin Core.
...
TX outputs, bloating beardcoin's UTXO database.
...
Using the standard "./autogen.sh; ./configure; make" to build Beardcoin-Qt and
...
("tell the running beardcoin daemon to do THIS") was split into a separate
executable, 'beardcoin-cli'. The RPC client code will eventually be removed from
...
- Rebrand to `Beardcoin Core`
- Move initialization/shutdown to a thread. This prevents "Not responding"
  messages during startup. Also show a window during shutdown.
- Don't regenerate autostart link on every client startup
- Show and store message of normal beardcoin:URI
- Fix richtext detection hang issue on very old Qt versions
- OS X: Make use of the 10.8+ user notification center to display Growl-like 
  notifications
- OS X: Added NSHighResolutionCapable flag to Info.plist for better font
  rendering on Retina displays.
- OS X: Fix beardcoin-qt startup crash when clicking dock icon
- Linux: Fix Gnome beardcoin: URI handler
...
- Add separate beardcoin-cli client
