...
In order to support loading of multiple wallets in beardcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beardcoin.cpp.

Finally, two new headers and source files will have to be added to beardcoin-qt.pro.
...
Changes to beardcoin.cpp
----------------------
beardcoin.cpp is the entry point into beardcoin-qt, and as such, will require some minor modifications to provide hooks for
